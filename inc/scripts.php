...
<script src='//unpkg.com/bootstrap-vue@2.0.2/dist/bootstrap-vue.min.js'></script>
...
<script src='<?php echo HTTP_ROOT; ?>/js/util.js'></script>
<script src='<?php echo HTTP_ROOT; ?>/js/question-components.js'></script>
